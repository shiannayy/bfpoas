...
--
-- Host: localhost
-- Generation Time: Oct 22, 2025 at 06:57 AM
...
INSERT INTO `inspection_schedule` (`schedule_id`, `checklist_id`, `HasClientAck`, `DateAckbyClient`, `AckByClient_id`, `hasRecommendingApproval`, `dateRecommendedForApproval`, `RecommendingApprover`, `hasFinalApproval`, `dateFinalApproval`, `FinalApprover`, `hasInspectorAck`, `dateInspectorAck`, `inspector_id`, `order_number`, `scheduled_date`, `preferredSchedule`, `rescheduleReason`, `to_officer`, `assigned_to_officer_id`, `proceed_instructions`, `gen_info_id`, `purpose`, `duration`, `remarks`, `inspection_sched_status`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 12, 'N', NULL, NULL, 1, '2025-10-21 10:34:15', 18, 0, NULL, NULL, 1, '2025-10-21 10:18:27', 16, 'R05-ADV-0001', '2025-11-01', '2025-11-01', 'eto na po', 'Sr Fire Officer Inspecsyon Taka', 16, 'Coca Cola Company - Oas Albay', 13, 'Conduct inspection of the said Establishment as required by RA 9514 RIRR Fire Code of the Philippines 2008 RIRR', 'Until the end of Inspection', '[Approved] Establishment Owner requested a reschedule to 2025-11-01 due to: eto na po', 'Scheduled', 18, '2025-10-21 16:17:37', '2025-10-21 16:58:20'),
(2, 12, 'Y', '2025-10-21 22:06:30', 13, 1, '2025-10-21 22:06:55', 18, 1, '2025-10-21 22:08:45', 15, 1, '2025-10-21 22:07:59', 16, 'R05-ADV-0002', '2025-11-08', NULL, NULL, 'Sr Fire Officer Inspecsyon Taka', 16, 'Cafe Locran - Café Locran by Lovecakes, Ragos Street, Oas, Albay, Philippines', 12, 'Conduct inspection of the said Establishment as required by RA 9514 RIRR Fire Code of the Philippines 2008 RIRR', 'Until the end of Inspection', '', 'Scheduled', 18, '2025-10-22 04:03:34', '2025-10-21 22:08:45');
...
(14, 'Sr Fire Officer Recommend Taka', 'sfo@fsic.gov', NULL, '$2y$10$bMwshjR.44b8ay6cIe3GbOE3.arGITWyvu2O5FYcqyn0gqfXAE4Gy', 'Administrator', 'Fire Marshall', 1, 'SIGN-14-Administrator.png', '2025-10-07 15:49:22', NULL, NULL),
(15, 'sr Fire Officer Approvado Taka', 'approver@fsic.gov', NULL, '$2y$10$uRZqZ4OEJipjfbH9V.56TuSoHFIllVXIFXZPCUwShvjlzRoZ4chAC', 'Administrator', 'Approver', 1, 'SIGN-15-Administrator.png', '2025-10-07 15:50:06', NULL, '2025-10-21 22:09:00'),
