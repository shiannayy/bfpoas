                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-2 input-group border border-1 align-content-center ">
                            ...
                            <label title="Attach Proof" for="proof_item_<?= $item['item_id'] ?>"
                                class="btn btn-navy rounded-2 ms-0 align-content-center"><?= getIcon("attach") ?></label>
                            ...
                            <div class="align-content-center d-inline not-applicable ms-1 p-0 <?= (!$notapp) ? 'd-none' : '' ?>" 
                                   id="na_<?= $item['item_id'] ?>">
                            ...
                            <span class="input-group-text fw-bold d-inline align-content-center ">
                            ...
                            <div class="input-group-text">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input section-input"
                            ...
                            <input type="text" class="form-control section-input" name="item_<?= $item['item_id'] ?>"
                        ...
                        elseif ($item['input_type'] === "number") { ?>
                            ...
                            <input type="date" class="form-control section-input" name="item_<?= $item['item_id'] ?>"
                                value="<?= htmlspecialchars($savedValue ?? '') ?>"
                                <?= $item['required'] ? 'required' : '' ?> />
