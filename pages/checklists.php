                                                        ...
                                                        <li class="list-group-item shadow mb-2">
                                                            <form class="editItemForm" data-item="<?= $item['item_id'] ?>">
                                                                <div class="row g-2 align-items-center">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <select name="input_type" data-item-id="<?= $item['item_id']?>" class="form-select form-select-sm edit-select-input-type">
                                                                            <?php
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <select name="checklist_criteria" id="editCriteriaSelect<?= $item['item_id']?>" class="form-select form-select-sm edit-criteria-select" data-item-id="<?= $item['item_id']?>" data-saved="<?= $item['checklist_criteria']?>"></select>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-12 mt-2 threshold-fields" id="threshold-edit-<?= $item['item_id'] ?>">
                                                                        <div class="threshold-field border range-fields border-secondary rounded-2 input-group <?= $criteria !== 'range' ? 'd-none' : '' ?>">
                                                                            <div class="form-floating">
                                                                                <input type="number" id="threshold_range_min_<?= $item['item_id'] ?>" name="threshold_range_min" class="form-control form-control-sm mb-2" step="0.01" placeholder="Min" value="<?= isset($item['threshold_range_min']) ? (float)$item['threshold_range_min'] : 0 ?>">
                                                                                <label for="threshold_range_min_<?= $item['item_id'] ?>">Min Value</label>
                                                                            </div>
                                                                            <div class="form-floating">
                                                                                <input type="number" id="threshold_range_max_<?= $item['item_id'] ?>" name="threshold_range_max" class="form-control form-control-sm mb-2" step="0.01" placeholder="Max" value="<?= isset($item['threshold_range_max']) ? (float)$item['threshold_range_max'] : 0 ?>">
                                                                        ...
                                                                        <div class="threshold-field minval-field form-floating <?= $criteria !== 'min_val' ? 'd-none' : '' ?>">
                                                                            <input type="number" id="threshold_min_val_<?= $item['item_id'] ?>" name="threshold_min_val" class="minval-field form-control form-control-sm mb-2" step="0.01" placeholder="Min" value="<?= isset($item['threshold_min_val']) ? (float)$item['threshold_min_val'] : 0 ?>">
                                                                        ...
                                                                        <div class="threshold-field maxval-field form-floating <?= $criteria !== 'max_val' ? 'd-none' : '' ?>">
                                                                            <input type="number" id="threshold_max_val_<?= $item['item_id'] ?>" name="threshold_max_val" class="form-control form-control-sm mb-2" step="0.01" placeholder="Max" value="<?= isset($item['threshold_max_val']) ? (float)$item['threshold_max_val'] : 0 ?>">
                                                                            <label for="threshold_max_val_<?= $item['item_id'] ?>">Max Value</label>
                                                                        </div>
                                                                        <select name="threshold_yes_no" class="threshold-field yesno-field form-select form-select-sm mb-2 <?= $criteria !== 'yes_no' ? 'd-none' : '' ?>">
                                                                            <option value="1" <?= $item['threshold_yes_no'] == 1 ? 'selected' : '' ?>>Yes</option>
                                                                            <option value="0" <?= $item['threshold_yes_no'] == 0 ? 'selected' : '' ?>>No</option>
                                                                        </select>
                                                                        <div class="threshold-field days-field form-floating <?= $criteria !== 'days' ? 'd-none' : '' ?>">
                                                                        ...
                                                                        <div class="threshold-field textvalue-field form-floating <?= $criteria !== 'textvalue' ? 'd-none' : '' ?>">
                                                            ...
                                                            ?>
                                                            <div class="card m-0 border-1 shadow-sm d-none add-select-form" id="<?= $item['item_id'] ?>">
