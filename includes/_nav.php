        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav nav-pills ms-auto me-3">
                    ...
                    <!-- <li class="nav-item">
                        <a class="nav-link" href="#" data-link="checklists">About Us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-link="schedule">Inspection Schedule</a>
                    </li> -->
                    <li class="nav-item">
                        <a class="nav-link" href="../pages/map.php" data-link="locator">Building Locator</a>
                    </li>
                    <li class="nav-item">
                        <a id="inspectorLogin" class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#loginModal">
                            Login
                        </a>
                    </li>
                </ul>
